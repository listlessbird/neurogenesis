...
import VantaDots from "@/app/vanta-dots"

export function Component() {
  return (
    <div className="flex flex-col min-h-[100dvh] relative">
      <VantaDots className="pointer-events-none fixed left-0 top-0 h-full w-full" />
      <div className="z-1 relative">
        <header className="px-4 lg:px-6 h-14 flex items-center">
          <Link className="flex items-center justify-center" href="#">
            <MountainIcon className="h-6 w-6" />
            <span className="sr-only">Neurogenesis</span>
          </Link>
          ...
          <section className="w-full py-6 sm:py-12 md:py-24 lg:py-32 xl:py-48">
            <div className="container px-4 md:px-6 mx-auto">
              <div className="grid gap-6 lg:grid-cols-[1fr_400px] lg:gap-12 xl:grid-cols-[1fr_600px]">
                <Image
                  alt="Hero"
                  className="mx-auto aspect-video overflow-hidden rounded-xl object-cover object-center sm:w-full lg:order-last invisible"
                  height="310"
                  src="/neuro.webp"
                  width="550"
                />
                <div className="flex flex-col justify-center space-y-4">
                  <div className="space-y-2">
                    ...
                    <p className="max-w-[600px] text-gray-500 md:text-xl dark:text-gray-400">
                      Use our web app to predict neurodegenerative diseases with
                      high accuracy. Early detection. Better treatment.
                    </p>
                  </div>
